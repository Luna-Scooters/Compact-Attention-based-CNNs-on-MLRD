...
tf.keras.utils.plot_model(
    fp32_model,
    to_file='wandb-MNV2-SE-cropped-0.1.png',
    show_shapes=True,
    show_dtype=True,
...
folder_path = 'Models/wandb-MNV2-SE-cropped-224-224'
...
checkpoint = tf.keras.callbacks.ModelCheckpoint('Models/wandb-MNV2-SE-cropped-224-224/wandb-MNV2-SE-cropped.h5', 
                                                monitor='val_loss', 
                                                mode='min', 
                                                verbose=1, 
                                                save_best_only=True)
