...
from keras.layers import Activation, BatchNormalization, Conv2D, Dense, Dropout, Flatten, MaxPool2D, Input, DepthwiseConv2D, ReLU, AvgPool2D,GlobalAveragePooling2D, Concatenate, Add, GlobalAvgPool2D, Reshape, Permute, Lambda, GlobalMaxPool2D
